...
describe('Books', () => {
    ...
    describe('/GET book', () => {
        it('it should GET all the books', (done) => {
            chai.request(app)
                .get('/book')
                .set('authorization', 'helloworld') // set headers property req.headers.authorization = 'helloworld'
                .query({offset: 0, limit: 9}) // req.query
                //set headers property Authenticate with Basic authentication , req.headers.authorization = 'Basic QXV0aG9yaXphdGlvbjpoZWxsb3dvcmxk'
